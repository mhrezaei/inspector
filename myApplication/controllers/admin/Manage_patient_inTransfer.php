...
class Manage_patient_inTransfer extends CI_Controller {
	...
	public function __construct()
    {
        ...
        $this->load->model('adminPages/managePatientInTransfer_model');
    ...
    public function index()
	{
        ...
        $pt['pt'] = $this->managePatientInTransfer_model->patient_data();
        $data = '';
        ...
        $this->load->view('adminPages/managePatientInTransfer', $pt);
