...
class Manage_patient_not_brain_death extends CI_Controller {
	...
	public function __construct()
    {
        ...
        $this->load->model('inspectorPages/ManagePatientNotBrainDeath_model');
	...
	{
        $pt['pt'] = $this->ManagePatientNotBrainDeath_model->patient_data();
        $data = '';
        ...
        $this->load->view('inspectorPages/managePatientNotBrainDeath', $pt);
