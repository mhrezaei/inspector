...
class Manage_patient extends CI_Controller {
	...
	public function __construct()
    {
        ...
        $this->load->model('inspectorPages/managePatient_model');
	...
	{
        $hospitalData['pt'] = $this->managePatient_model->patient_data();
        $data = '';
        ...
        $this->load->view('inspectorPages/managePatient', $hospitalData);
