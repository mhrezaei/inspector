...
class Manage_patient_deleted extends CI_Controller {
	...
	public function __construct()
    {
        ...
        $this->load->model('inspectorPages/ManagePatientDeleted_model');
	...
	{
        $pt['pt'] = $this->ManagePatientDeleted_model->patient_data();
        $data = '';
        ...
        $this->load->view('inspectorPages/managePatientDeleted', $pt);
