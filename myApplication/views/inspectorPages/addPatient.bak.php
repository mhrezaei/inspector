    ...
    <div class="panel-body panelBodyText" id="loginInfoBody" style="width: 100%; text-align: right; margin: 0 auto;">
        <div style="width: 100%; height: auto; direction: rtl; margin: 0 auto;">
            ...
            <div id="addPatientFrom" style="width: 1000px; margin: 0 auto;">
                ...
                <div role="alert" class="alert alert-danger" style="padding: 10px; width: 50%; margin: 0 auto; font-family: 'BNazanin'; font-weight: normal; text-align: center; display: none;" id="dangerAlert">لطفا موارد ستاره دار را به درستی تکمیل نمائید.</div>
