<title><?php echo $siteTitle; ?> | لیست بیماران نامناسب</title>
<style type="text/css">
    #states th, #states td{
        text-align: right;
    }
...
<div class="panel panel-success panelContent" id="loginInfo">
    <div class="panel-heading" style="padding-left: 0px;">
        <h3 class="panel-title panelTitleText" style="font-family: 'webYekan'; font-size: 14px;">لیست بیماران نامناسب <small style="font-size: 12px; font-family: 'BYekan';">(کل بیماران یافت شده: <?php echo $pt['totalRecords']; ?>)</small></h3>
