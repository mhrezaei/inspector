<title><?php echo $siteTitle; ?> | لیست بیماران حذف شده</title>
<style type="text/css">
    #states th, #states td{
        text-align: right;
    }
...
<div class="panel panel-success panelContent" id="loginInfo">
    <div class="panel-heading" style="padding-left: 0px;">
        <h3 class="panel-title panelTitleText">لیست بیماران حذف شده <small style="font-size: 12px;">(کل بیماران یافت شده: <?php echo $pt['totalRecords']; ?>)</small></h3>
