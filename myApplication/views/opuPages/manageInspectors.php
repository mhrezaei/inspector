                ...
                <form style="width: 98%" class="form-inline" role="form" method="get">
                    <div class="form-group" style="float: right;">
                        ...
                        <div style="float: right; width: 640px;">
                            <input type="text" class="form-control" name="inputInspectorFilter" id="inputInspectorFilter" style="font-family: 'BYekan'; width: 640px;" value="<?php echo $this->input->get('inputInspectorFilter'); ?>" placeholder="نام بازرس، کدملی یا شماره موبایل ...">
                    ...
                    <button type="button" class="btn btn-warning btn-md" style="float: right; margin: 0px 5px 20px auto; margin-top: 15px;" onclick="window.location='<?php echo base_url() ?>opu/manage_inspectors';">حذف فیلتر</button>
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="hidden" value="1" id="cbInpectorOpu">
                            </div>
                        </div>
                    ...
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="hidden" value="1" id="cbInpectorOpuEdit">
                            </div>
                        </div>
