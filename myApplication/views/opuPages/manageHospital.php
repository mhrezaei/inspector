        ...
        <div style="width: 100%; height: auto; direction: rtl; margin: 0 auto;">
            ...
            <div style="height: auto; margin: 0px auto; text-align: right; width: 100%;">
                <form style="width: 98%" class="form-inline" role="form" method="get">
                    ...
                    <button type="button" class="btn btn-warning btn-md" style="float: right; margin: 0px 5px 20px auto;" onclick="window.location='<?php echo base_url() ?>opu/manage_hospital';">حذف فیلتر</button>

                    <button type="button" class="btn btn-success btn-md" style="margin: 0px 5px 20px auto; float: right;" onclick="addNewHospital();" data-toggle="modal" data-target="#addHospitalModal">افزودن بیمارستان جدید</button>
                    ...
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="hidden" id="cbAddOpu" value="<?php echo $session['uid']; ?>">
                            </div>
                        </div>
                    ...
                    <form class="form-horizontal" role="form" name="editHospitalForm">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <?php $session = $this->session->userdata('user'); ?>
                                <input type="hidden" id="cbAddOpuEdit" value="<?php echo $session['uid']; ?>">
                            </div>
                        </div>
