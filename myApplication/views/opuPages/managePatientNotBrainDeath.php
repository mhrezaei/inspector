<title><?php echo $siteTitle; ?> | لیست بیماران GCS3 مرگ مغزی نشده</title>
<style type="text/css">
    #states th, #states td{
        text-align: right;
    }
...
<div class="panel panel-success panelContent" id="loginInfo">
    <div class="panel-heading" style="padding-left: 0px;">
        <h3 class="panel-title panelTitleText" style="font-family: 'webYekan'; font-size: 14px;">لیست بیماران GCS3 مرگ مغزی نشده <small style="font-size: 12px; font-family: 'BYekan';">(کل بیماران یافت شده: <?php echo $pt['totalRecords']; ?>)</small></h3>
    ...
    <div class="panel-body panelBodyText" id="loginInfoBody" style="width: 100%; text-align: right; margin: 0 auto;">
        <div style="width: 100%; height: auto; direction: rtl; margin: 0 auto;">
            ...
            <?php
                $this->view('opuPages/patientsSearchForm');
            ?>
            <div class="clearB"></div>
