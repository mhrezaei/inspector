<div class="row" style="width: 98%; margin: 0 auto; position: relative;">
        <div class="col-md-2 dataComponent">
            ...
            <div class="dataComponentOneL">
                ...
                <div class="dataComponentText" style="font-size: 30px; line-height: 22px;"><?php echo number_format($total); ?></div>
            </div>
        </div>
...
<?php
    ...
    ?>    
<!-- opu patient modal -->
<div class="modal fade" id="opuPatientResultModal" tabindex="-1" role="dialog" aria-labelledby="opuPatientResultModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="archiveModalLabel" style="font-family: 'BYekan';">بیماران درحال پیگیری</h4>
      </div>
      <div class="modal-body" id="opuPatientResultModalBodyData">
            
            <div id="activeQuestion" style="width: 90%; margin: 0px auto; text-align: justify; font-family: 'BNazanin',Tahoma; font-size: 16px;">
                مدیریت محترم واحد فراهم آوری، <span style="font-weight: bold; color: #2B689B;"><?php echo $name;?></span> در حال حاضر شما <span style="font-weight: bold; color: #ED9F2F;"> <?php echo $ready;?> </span> بیمار درحال پیگیری در سامانه خود دارید.
            </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal" style="float: left; font-family: 'BYekan';">بستن</button>
      </div>
    </div>
  </div>
</div>
