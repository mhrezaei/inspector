        ...
        <div style="width: 100%; height: auto; direction: rtl; margin: 0 auto;">
            ...
            <div id="addPatientFrom" style="width: 1000px; margin: 0 auto;">
                ...
                <?php if($patientInsertStatus == 1){ ?>
                    ...
                    <div role="alert" class="alert alert-danger" style="padding: 10px; width: 50%; margin: 0 auto; font-family: 'BNazanin'; font-weight: normal; text-align: center;">لطفاً موارد خواسته شده را به درستی وارد نمائید.</div>
                ...
                <div class="form-group" style="margin-left: 0px; margin-right: 0px;">
                    ...
                    <div style="float: right; width: 230px;">
                        <input type="text" class="form-control" id="inputFullName" name="inputFullName" style="font-family: 'BNazanin';" value="" placeholder="حروف فارسی وارد نمائید">
                    </div>
                    ...
                    <div style="float: right; width: 230px;">
                        <input type="text" class="form-control" id="inputNationalCode" name="inputNationalCode" style="font-family: 'BNazanin'; direction: ltr;" value="" placeholder="ده رقم بدون خط تیره" maxlength="10">
                ...
                <div class="form-group" style="margin-left: 0px; margin-right: 0px;">
                    ...
                    <div style="float: right; width: 180px;">
                        <input type="text" class="form-control" id="inputFirstGCS" name="inputFirstGCS" style="font-family: 'BNazanin'; direction: ltr;" value="" placeholder="3 ~ 15">
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-left: 0px; margin-right: 0px;">
                    <label for="cbOpu" class="control-label" style="float: right; font-family: 'BNazanin'; font-weight: normal; text-align: right; width: 130px;">واحد فراهم آوری<span style="color: red;"> *</span>:</label>
                    <div style="float: right; width: 370px;">
                        <select class="form-control" id="cbOpu" name="cbOpu" style="font-family: 'BNazanin'; direction: rtl;" disabled="disabled">
                            <option value="0">انتخاب کنید...</option>
                        </select>
                    </div>
                    ...
                    <div style="float: right; width: 370px;">
                        <select class="form-control" id="cbHospitals" name="cbHospitals" style="font-family: 'BNazanin'; direction: rtl;" disabled="disabled">
                            <option value="0">انتخاب کنید...</option>
                        </select>
                    </div>
                </div>
                ...
                <button type="button" class="btn btn-success" style="float: left; font-family: 'BYekan'; margin-bottom: 15px;" id="saveBTN">ارسال اطلاعات</button>

                <div role="alert" class="alert alert-danger" style="padding: 10px; width: 50%; margin: 0 auto; font-family: 'BNazanin'; font-weight: normal; text-align: center; display: none;" id="dangerAlert">لطفاً موارد خواسته شده را به درستی وارد نمائید.</div>
                <div role="alert" class="alert alert-danger" style="padding: 10px; width: 50%; margin: 0 auto; font-family: 'BNazanin'; font-weight: normal; text-align: center; display: none;" id="dangerAlert2">وارد نمودن آزمایشات به درستی الزامی می باشد.</div>
                <?php if($patientInsertStatus == 1){ ?>
                    <div role="alert" class="alert alert-success" style="padding: 10px; width: 50%; margin: 0 auto; font-family: 'BNazanin'; font-weight: normal; text-align: center;">اطلاعات بیمار مورد نظر با موفقیت ذخیره شد.</div>
                    <?php }elseif($patientInsertStatus == 2){ ?>
                    <div role="alert" class="alert alert-danger" style="padding: 10px; width: 50%; margin: 0 auto; font-family: 'BNazanin'; font-weight: normal; text-align: center;">خطایی در ثبت اطلاعات رخ داده است، لطفا با مسئول سایت تماس بگیرید.</div>
                    ...
                    <?php }elseif($patientInsertStatus == 7){ ?>
                        <div role="alert" class="alert alert-danger" style="padding: 10px; width: 50%; margin: 0 auto; font-family: 'BNazanin'; font-weight: normal; text-align: center;">وارد نمودن آزمایشات به درستی الزامی می باشد.</div>
                    <?php }elseif($patientInsertStatus == 8){ ?>
                        <div role="alert" class="alert alert-danger" style="padding: 10px; width: 50%; margin: 0 auto; font-family: 'BNazanin'; font-weight: normal; text-align: center;">بخشی از اطلاعات به صورت ناقص وارد شده است، لطفاً دوباره تلاش نمائید.</div>
                    <?php } ?>
