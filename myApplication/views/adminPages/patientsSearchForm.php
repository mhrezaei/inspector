                ...
                <form style="width: 98%" class="form-inline" role="form" method="get">
                    <div class="form-group" style="float: right;">
                        ...
                        <div style="float: right; width: 320px;">
                            <input type="text" class="form-control" name="inputPatientFilter" id="inputPatientFilter" style="font-family: 'BNazanin'; width: 320px;" value="<?php echo $this->input->get('inputPatientFilter'); ?>" placeholder="نام بیمار، کدملی، شماره پرونده، سن یا GCS اولیه...">
                            <input type="hidden" class="form-control" name="searchTools" value="true">
                        </div>
                    </div>
                    <div class="form-group" style="float: right;">
                        <label for="cbOpu" class="control-label" style="float: right; font-family: 'BNazanin'; font-weight: normal; width: 100px; font-size: 14px; line-height: 28px; margin-right: 15px;">واحد فراهم آوری: </label>
                        <div style="float: right; width: 230px;">
                            <select class="form-control" id="cbOpu" name="cbOpu" style="font-family: 'BNazanin'; direction: rtl; width: 230px;" onchange="insertHospital('cbHospital', 'cbOpu', false, 'opuId'); insertInspectors('cbInspector', 'cbOpu', false);">
